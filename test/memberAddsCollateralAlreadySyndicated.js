...
contract('Consortium', async (accounts) => {
  it("Member adds a collateral to the consortium which is already syndicated\n\n",
    async () => {
        ...
        try {
          ...
          assert.equal(e,
            "Error: VM Exception while processing transaction: revert This collateral is already syndicated.",
