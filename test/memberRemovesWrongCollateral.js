...
contract('Consortium', async (accounts) => {
  it("Member tries to remove a wrong collateral from the consortium\n\n",
    async () => {
        ...
        try {
          msg = await instance.removeCollateral(collateral1,{from:account2});
        } catch(e){
          assert.equal(e,
            "Error: VM Exception while processing transaction: revert This collateral does not belong to you",
